...
const PrivacyPage = () => {
  return (
    <div className="privacyContainer">
      <h1>Privacy Policy for smileyt</h1>

      <p>
        At smileyt, accessible from smileyt.com, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by smileyt and how we use
        it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in smileyt. This policy is not applicable to any
      ...
      <p>
        smileyt follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, smileyt uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of smileyt.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on smileyt, which are sent directly
      ...
      <p>
        Note that smileyt has no access to or control over these cookies that
      ...
      <p>
        smileyt's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        smileyt does not knowingly collect any Personal Identifiable Information

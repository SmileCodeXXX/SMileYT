...
const TermAndAgreementPage = () => {
  return (
    <div className="privacyContainer">
      ...
      <p>Welcome to smileyt!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of smileyt's Website, located at smileyt.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use smileyt if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing smileyt, you agreed to use
        cookies in agreement with the smileyt's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, smileyt and/or its licensors own the
        intellectual property rights for all material on smileyt. All
        intellectual property rights are reserved. You may access this from
        smileyt for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from smileyt</li>
        <li>Sell, rent or sub-license material from smileyt</li>
        <li>Reproduce, duplicate or copy material from smileyt</li>
        <li>Redistribute content from smileyt</li>
      </ul>
      ...
      <p>
        ...
        smileyt does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of smileyt,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, smileyt shall not be liable for the
      ...
      <p>
        smileyt reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant smileyt a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of smileyt; and (d) the link is in
      ...
      <p>
        ...
        e-mail to smileyt. Please include your name, your organization name,
      ...
      <p>
        No use of smileyt's logo or other artwork will be allowed for linking
...
export default TermAndAgreementPage;
